...
class Spielfeld {
    ...
    * Speicherung der Karten in einem 2D-Array<br>
    ...
    /**<br>
    * Die Punkte des Spielers<br>
    <br>*/
    private int punkte;
    
    /**<br>
    * Die Punkte als Text<br>
    <br>*/
    ...
    * @param _spalten Die Spalten des Spielfeldes<br>
    ...
    public Spielfeld(int _zeilen, int _spalten) {
        ...
        punkte = 0;
        punkteText = new Text(500, 0, String.valueOf(punkte), "#000000", 20, "punkte");
        
        new Text(500, 50, "Ende", "#000000", 20, "ende");
    }
    
    /**<br>
    * F&uuml;gt die Punkte zum Punktestand hinzu. Es k&ouml;nnen auch mit negativen Punkten der Punktestand verringert werden.<br>
    * @param _punkte Die Punkte, die hinzugef&uuml;gt werden sollen.<br>
    <br>*/
    public void addPunkte(int _punkte) {
    	punkte += _punkte;
        punkteText.setText(String.valueOf(punkte));
    }
    ...
    public void zufaelligFuellen() {
    	for(int zeile = 0; zeile < zeilen; zeile++) {
        	for(int spalte = 0; spalte < spalten; spalte++) {
                ...
                spielfeld[zeile][spalte] = erstelleKarte(zufallsZahl(6), zeile, spalte);
            }
        }
    }
    
    /**<br>
    * Generiert eine zuf&auml;llige Zahl von 1 bis max (einschlie&szlig;lich max). Also wenn max = 7 ist, wird eine Zahl zwischen 1 und 7 erstellt.<br>
    <br>*/
    ...
    * @return Die jeweilige Richtungskarte<br>
    <br>*/
    private Karte erstelleKarte(int richtung, int zeile, int spalte) {
        ...
        if(richtung == 4) return new LKarte(zeile, spalte, this);
        if(richtung == 5) return new FKarte(zeile, spalte, this);
        return new ZKarte(zeile, spalte, this);
    }
