...
class Karte {    
    ...
    * G&uuml;ltige Farben <br>
    <br>*/
    private static final String[] GUELTIGE_FARBEN = {"schwarz", "weiß", "rot", "grün", "blau", "gelb", "magenta", "cyan"};
    ...
    * @return Zuf&auml;llige g&uuml;ltige Farbe<br>
    <br>*/
    protected String zufallsFarbe() {
    	int max = GUELTIGE_FARBEN.length - 1; // Zufallszahl zwischen 0 und 7
        return GUELTIGE_FARBEN[zufallsZahl(max)];
    }
	...
	* @param neueFarbe - Die neue Farbe<br>
	...
	void setzeAussehen(String neueFarbe) {
        ...
        for(String gueltigeFarbe : GUELTIGE_FARBEN) {
	...
	* @param andereKarte - Die andere Karte, von der das Aussehen &uuml;bernommenw erden soll.<br>
	...
	void uebernehmeAussehen(Karte andereKarte) {
		this.setzeAussehen(andereKarte.farbe);
	}
